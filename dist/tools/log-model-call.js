 ...
 */
export function createLogModelCallTool(store) {
    return async (input) => {
        // Validate input
...
export const logModelCallToolDefinition = {
    name: "log_model_call",
    description: "Log a model call for tracking AI usage metrics. Call this after each model invocation to record the interaction.",
    inputSchema: {
        type: "object",
        properties: {
            project: {
...
//# sourceMappingURL=log-model-call.js.map